...
export default function ComparisonSection() {
  const sections = [
    {
      ...
      features: [
        ...
        },
        {
          ...
          desc: "Recreate and modify image backgrounds",
        },
        {
          name: "Video generation",
          desc: "Create product videos with AI",
        },
        {
          name: "Ad generation",
          desc: "Generate advertising creative automatically",
        },
        {
          name: "AI editing tools",
          desc: "Edit and refine images with AI assistance",
        },
      ],
    },
    {
      ...
      features: [
        {
          ...
          desc: "Manage your brand assets in one place",
        },
        {
          name: "Template customization",
          desc: "Design custom brand templates",
        },
        {
          name: "Brand consistency checks",
          desc: "Ensure brand style across all assets",
        },
      ],
    },
  ];
  ...
  const pebblySupports = [
    false, false, false, true, false, false, false, false, false, false,
  ];
  const botikaSupports = [
  ...
  return (
    <section className="py-20 px-4 md:px-6 w-[95%] md:w-[85%] mx-auto bg-black">
      ...
      <div className="overflow-hidden rounded-2xl border border-gray-700 bg-[#0D0D0D]/70 backdrop-blur-md">
        <table className="min-w-full table-fixed">
          <thead>
            <tr className="text-gray-400">
              <th className="text-left py-4 px-6 w-1/2">Features</th>
              <th className="text-center py-4 px-4">Flair</th>
              <th className="text-center py-4 px-4">Pebbly</th>
              <th className="text-center py-4 px-4">Botika</th>
              <th className="text-center py-4 px-4">Claid</th>
            </tr>
          </thead>
          <tbody>
            {sections.map((section, sectionIndex) => (
              <React.Fragment key={sectionIndex}>
                {section.title !== "" && (
                  <tr>
                    <td
                      className="py-4 px-6 text-left text-gray-400 uppercase tracking-wide text-sm"
                      colSpan={5}
                    >
                      {section.title}
                    </td>
